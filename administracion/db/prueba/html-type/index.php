	...
	<div class="container">
        ...
        <div class="row">
        	...
        	<div class="col-lg-12">
            		...
            		<?php
            		$conexion = new PDO("sqlite:bbdd.db");
            		$conexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
					$resultado = $conexion->query("SELECT * from ofertas");
					
            		while($row=$resultado->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT)){
						?>
						<tr>
						<td><?php echo $row['articulo']."&nbsp;".$row['texto']; ?></td>
						<td>
