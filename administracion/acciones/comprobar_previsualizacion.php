...
#
# Esta funci�n comprueba si existe el preview de la pel�cula y si no existe lo crea.
# 
#=================================================================================
...
for ($i=1;$i<$cuadros;$i++)
{
	...
	$img_resized = ImageCreateTrueColor($anchura_final,$altura_final); 
	if(ImageCopyResized($img_resized,$gd_imagen[$i], 0,0,0,0, $anchura_final,$altura_final, $anchura,$altura )) 
        { 
            ImageDestroy($gd_imagen[$i]); 
            $gd_imagen[$i] = $img_resized; 
            
        } 

	//echo "hola".$anchura ;exit;
...
//comprobar_previsualizacion("1.mp4","./","0");
