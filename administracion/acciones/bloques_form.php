...
if (isset($_GET))
{
	...
	$resultado = $bbdd->consulta("SELECT * from bloques where id = '".$id."'","SELECT","BLOQUES",session_id());
...
<form class="form-horizontal" role="form" action="?page=estilos_add" method="post" enctype="multipart/form-data">
    ...
    <legend>Agregar Bloques</legend>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Bloque</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="bloque" value="<?php echo $bloque;?>"  id="bloque" placeholder="Tipo de bloque">
      </div>
    </div>
     <div class="form-group">
